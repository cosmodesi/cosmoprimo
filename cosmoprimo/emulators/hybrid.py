...
class CAPSEEngine(EmulatedEngine):
    ...
    name = 'capse'
    path = {train_dir / 'camb_base_mnu_w_wa/emulator_thermodynamics.npy': 'https://github.com/adematti/cosmoprimo-emulators/raw/refs/heads/main/camb_base_mnu_w_wa/emulator_thermodynamics.npy',
