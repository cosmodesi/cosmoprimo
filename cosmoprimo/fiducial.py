...
def AbacusSummitBase(engine='class', precision=None, extra_params=None, **params):
    ...
    cosmology : Cosmology
    """
    default_params = dict(h=0.6736, omega_cdm=0.12, omega_b=0.02237, Omega_k=0., A_s=2.083e-09, k_pivot=0.05, n_s=0.9649,
                          omega_ncdm=[0.0006442], neutrino_hierarchy=None, T_ncdm_over_cmb=constants.TNCDM_OVER_CMB, N_ur=2.0328, tau_reio=0.0544,
